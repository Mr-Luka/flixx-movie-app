...
//    window.location.search - ?id=533535
//    window.location.search.split('=') - ['?id' , 533535]
    const showId = window.location.search.split('=')[1]  // 533535
...
function displaySearchResults(results) {
        ...
        div.innerHTML = ` 
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <small class="text-muted">Air Date: ${global.search.type 
                === 'movie' ? result.release_date : result.first_air_date}</small>
            </p>
          </div>
        `;
